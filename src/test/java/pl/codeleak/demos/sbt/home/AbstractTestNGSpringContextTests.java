...
import pl.codeleak.selenium.support.SeleniumTestExecutionListener;
...
public abstract class AbstractTestNGSpringContextTests implements IHookable,
  ...
  /**
   * Delegates to the configured {@link TestContextManager} to call {@link
  ...
  /**
   * Delegates to the configured {@link TestContextManager} to {@link
